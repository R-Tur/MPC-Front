Web GUI for the Media Player Classic (MPC, command-line utility), can be used with Icecast2 and Music Player Daemon (MPD) for easy radio stream management (changing tracks, etc).
